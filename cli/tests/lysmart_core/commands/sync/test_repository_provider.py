...
from lysmart_core.commands.sync.providers.repositories.provider import (
...
class TestRepositorySyncProvider:
    ...
    def test_get_items_returns_repos_from_config(self):
        provider = RepositorySyncProvider()
        mock_config = MagicMock(spec=LySmartConfig)
        mock_config.repos = [
    ...
    @patch("lysmart_core.commands.sync.providers.repositories.provider.clone_or_pull_repo")
    @patch("lysmart_core.commands.sync.providers.repositories.provider.console")
...
class TestCloneOrPullRepo:
    @patch("lysmart_core.commands.sync.providers.repositories.provider.subprocess.run")
    @patch("lysmart_core.commands.sync.providers.repositories.provider.console")
