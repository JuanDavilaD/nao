...
from lysmart_core.commands.sync import sync
from lysmart_core.commands.sync.providers import ProviderSelection, SyncProvider, SyncResult
...
class TestSyncCommand:
    ...
    def test_sync_runs_providers_when_config_exists(self, create_config):
        ...
        with patch("lysmart_core.commands.sync.console"):
    ...
    def test_sync_prints_nothing_to_sync_when_no_results(self, create_config):
        ...
        with patch("lysmart_core.commands.sync.console") as mock_console:
            sync(_providers=[selection])
