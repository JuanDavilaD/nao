...
def create_config(tmp_path, monkeypatch):
    """Factory fixture to create a LySmart config file and chdir to tmp_path."""

    def _create(content: str = "project_name: test-project\n"):
        config_file = tmp_path / "lysmart_config.yaml"
...
def mock_socket():
    ...
    with patch("socket.socket") as mock_socket_cls:
        ...
        with patch("lysmart_core.commands.chat.sleep"):
            yield mock_sock
