...
from lysmart_core.ui import UI, ask_confirm, ask_select, ask_text
...
class TestAskText:
    ...
    @patch("lysmart_core.ui.questionary.text")
    ...
    @patch("lysmart_core.ui.questionary.password")
...
class TestAskConfirm:
    ...
    @patch("lysmart_core.ui.questionary.confirm")
...
class TestAskSelect:
    ...
    @patch("lysmart_core.ui.questionary.select")
