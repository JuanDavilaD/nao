...
class GitContextProvider(ContextProvider):
    ...
    def init(self) -> None:
        ...
        Raises:
            ...
            ValueError: If cloned repo doesn't contain lysmart_config.yaml.
        """
        ...
        if not self.validate():
            raise ValueError(
                "lysmart_config.yaml not found in cloned repository.\n"
                "Ensure the repository contains a valid LySmart project at its root."
            )
