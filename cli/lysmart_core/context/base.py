...
class ContextProvider(ABC):
    ...
    A context provider is responsible for loading the LySmart project context
    ...
    def validate(self) -> bool:
        ...
        Returns:
            True if lysmart_config.yaml exists in target path.
        """
        config_file = self.target_path / "lysmart_config.yaml"
