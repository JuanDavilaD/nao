...
class LocalContextProvider(ContextProvider):
    ...
    def init(self) -> None:
        ...
        Raises:
            ...
            ValueError: If lysmart_config.yaml is not found.
        """
        ...
        if not self.validate():
            raise ValueError(
                f"lysmart_config.yaml not found in {self.target_path}\n"
                "Ensure the context path contains a valid LySmart project."
            )
    ...
    def is_initialized(self) -> bool:
        ...
        Returns:
            True if target path exists and contains lysmart_config.yaml.
        """
