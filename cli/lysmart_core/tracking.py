"""PostHog analytics tracking for LySmart CLI.

This module provides analytics tracking to help improve LySmart.
...
DISTINCT_ID_FILE = Path.home() / ".lysmart" / "distinct_id"
...
def track_command(command_name: str) -> Callable[[F], F]:
    ...
    - Persistent distinct_id (stored in ~/.lysmart/distinct_id)
    ...
    def decorator(func: F) -> F:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            base_properties: dict[str, Any] = {
                ...
                "mode": MODE,
                "lysmart_core_version": __version__,  # Set `lysmart_core_version` in event and person properties for convenience
                "$set": {
                    "lysmart_core_version": __version__,
                },
                "$set_once": {
                    "first_lysmart_core_version": __version__,
                },
            }
