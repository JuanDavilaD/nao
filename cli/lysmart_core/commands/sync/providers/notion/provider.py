...
from lysmart_core.config.notion import NotionConfig
...
def extract_page_id(page_url: str) -> str:
    ...
    Handles URLs like:
    - https://www.notion.so/lysmart-labs/Conversational-analytics-2bfc7a70bc0680978900d1e85ece83a0
...
class NotionSyncProvider(SyncProvider):
    ...
    def get_items(self, config: LySmartConfig) -> list[NotionConfig]:
