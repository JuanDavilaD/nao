...
from lysmart_core.commands.sync.cleanup import cleanup_stale_repos
...
class RepositorySyncProvider(SyncProvider):
    ...
    def get_items(self, config: LySmartConfig) -> list[RepoConfig]:
        return config.repos
    ...
    def sync(self, items: list[Any], output_path: Path, project_path: Path | None = None) -> SyncResult:
        ...
        Args:
                ...
                project_path: Path to the LySmart project root (unused for repos)
