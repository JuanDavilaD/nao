...
<head>
    ...
    <title>LySmart Test Results</title>
        ...
        function App() {
            ...
            return (
                <div className="container">
                    <header>
                        <h1>LySmart <span>Test Results</span></h1>
...
def server(
    ...
    Examples:
        lysmart test server
        lysmart test server --port 9000
        lysmart test server --no-open
    """
    ...
    if not outputs_dir.exists():
        ...
        UI.info("Run 'lysmart test' first to generate test results.")
        return
    ...
    UI.info("\n📊 Starting LySmart test results server...\n")
