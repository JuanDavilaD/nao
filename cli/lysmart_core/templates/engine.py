...
# Path to the default templates shipped with LySmart
...
class TemplateEngine:
    ...
    2. Default templates shipped with LySmart

    This allows users to customize output by creating a `templates/` folder
    in their LySmart project and adding templates with the same names as the defaults.
    ...
    def __init__(self, project_path: Path | None = None):
        ...
        Args:
            project_path: Path to the LySmart project root. If provided,
