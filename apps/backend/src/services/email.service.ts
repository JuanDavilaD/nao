...
class EmailService {
	...
	private createUserAddedToProjectEmail({
		...
		const subject = isNewUser
			? `You've been invited to ${projectName} on LySmart`
			: `You've been added to ${projectName} on LySmart`;
...
You've been invited to join the project "${projectName}" on LySmart.
...
---
This is an automated message from LySmart.
        `.trim()
			: `
New Project Access
...
Great news! You've been added to the project "${projectName}" on LySmart.

You can now access this project using your existing LySmart account.
...
This is an automated message from LySmart.
	...
	private createResetPasswordEmail({
		...
		const subject = `Your password on the project ${projectName} has been reset on LySmart`;
