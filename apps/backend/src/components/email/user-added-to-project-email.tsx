	...
	return (
		<EmailLayout>
			...
			<p>
				{isNewUser ? (
					<>
						You've been invited to join the project <strong>{projectName}</strong> on LySmart.
					</>
				) : (
					"You've been added to a new project on LySmart."
				)}
			</p>
			...
			{isNewUser ? (
				...
				<div className='info-box'>
					...
					<p>You can now access this project using your existing LySmart account.</p>
				</div>
			)}

			<EmailButton href={loginUrl}>Login to LySmart</EmailButton>
			...
			<div className='footer'>
				<p>This is an automated message from LySmart.</p>
			</div>
		</EmailLayout>
	);
}
